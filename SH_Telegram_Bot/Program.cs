...
namespace SH_Telegram_Bot
{
    class Program
    {
        private static readonly TelegramBotClient Bot = new TelegramBotClient("259031324:AAEWZebhimXA89VbLzfywEUOQupBkdXZvLQ");
        ...
        static void Main(string[] args)
        {
            ...
            var t = Bot.SendTextMessage("@BootTest", "sdfsdf"); 
