...
#define EEPROM_SHUTTER_FULL_DURATION        (EEPROM_HTTP_PASSWORD_AUTH_OFFSET + EEPROM_DATA_LENGTH_OFFSET + SHUTTER_FULL_DURATION_LENGTH)
#define EEPROM_SHUTTER_CRACKS_DURATION      (EEPROM_SHUTTER_FULL_DURATION + EEPROM_DATA_LENGTH_OFFSET +  SHUTTER_CRACKS_DURATION_LENGTH)
